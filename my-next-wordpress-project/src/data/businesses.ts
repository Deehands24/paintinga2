...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    name: 'Five Star Painting of Ann Arbor',
  ...
  {
    id: 'truecoats-painting',
    name: 'TrueCoats Painting',
    slug: 'truecoats-painting',
    phone: '(248) 504-1832',
    address: 'Ypsilanti',
    city: 'Ypsilanti',
    state: 'MI',
    bbbRating: 'A+',
    description:
      'TrueCoats Painting is a BBB accredited painting contractor serving the Ann Arbor and Ypsilanti areas. With an A+ BBB rating, they provide professional painting services for residential and commercial properties. Their commitment to quality workmanship and customer satisfaction has earned them a strong reputation in the community.',
    services: ['residential', 'commercial', 'interior', 'exterior'],
    tier: 'basic',
    verified: true,
  },
