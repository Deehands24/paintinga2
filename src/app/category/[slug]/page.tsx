...
import { getBusinessesByCategory } from '@/lib/sanity-data';
...
export default async function CategoryPage({ params }: PageProps) {
  ...
  const categoryBusinesses = await getBusinessesByCategory(category.id);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="mb-8 text-sm">
          <ol className="flex items-center space-x-2 text-gray-600">
            ...
            <li>/</li>
            <li><Link href="/listings" className="hover:text-umich-navy">Listings</Link></li>
            <li>/</li>
        ...
        {categoryBusinesses.length > 0 ? (
          ...
          <div className="bg-gray-50 rounded-lg p-12 text-center">
            ...
            <Link
              href="/listings"
              className="inline-block bg-umich-navy text-white font-bold px-6 py-3 rounded-lg hover:bg-umich-navy transition-colors"
            >
              Browse All Painters
            </Link>
          </div>
            ...
            {categories
              ...
              .map((cat) => (
                ...
                >
                  ...
                  <span className="inline-flex items-center mt-4 text-umich-navy font-semibold group-hover:text-umich-navy">
                    View Painters
