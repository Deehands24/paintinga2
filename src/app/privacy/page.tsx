      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              To exercise these rights, please contact us at <a href="mailto:management@paintinga2.com" className="text-umich-navy hover:underline">management@paintinga2.com</a>.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              <strong>Email:</strong> <a href="mailto:management@paintinga2.com" className="text-umich-navy hover:underline">management@paintinga2.com</a><br />
